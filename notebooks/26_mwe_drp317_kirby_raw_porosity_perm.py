# %% [markdown]
# # MWE 26 - DRP-317 Kirby porosity and absolute permeability from RAW image
#
# This notebook estimates porosity and absolute permeability for:
#
# - `examples/data/drp-317/Kirby_2d25um_binary.raw`
#
# Provided experimental references from Table 1 of the Scientific Reports paper:
#
# - Absolute permeability: `Kabs = 62 mD`
# - Porosity: `phi = 19.95%`
# - Image resolution: `2.25 um`
# - Paper Table 1 sample label: `C`
#
# Workflow highlights:
#
...
# %%
# Inputs
raw_relpath = Path("drp-317") / "Kirby_2d25um_binary.raw"
voxel_size_um = 2.25
voxel_size_m = voxel_size_um * 1.0e-6

experimental_porosity_pct = 19.95
experimental_kabs_mD = 62.0
experimental_kabs_rel_error = 0.10  # +/-10%
paper_table_sample_label = "C"
...
fig = plot_network_plotly(
    ...
    title=(
        f"DRP-317 Kirby network ({flow_axis}-spanning) - pressure field "
...
out_net_full_h5 = out_dir / "Kirby_2d25um_network_full_voids.h5"
out_net_span_h5 = out_dir / f"Kirby_2d25um_network_{flow_axis}spanning_voids.h5"
out_props_csv = out_dir / "Kirby_2d25um_estimated_properties.csv"
out_stats_csv = out_dir / "Kirby_2d25um_network_stats.csv"
out_kabs_dir_csv = out_dir / "Kirby_2d25um_kabs_directional.csv"
out_roi_scan_csv = out_dir / "Kirby_2d25um_roi_scan.csv"
