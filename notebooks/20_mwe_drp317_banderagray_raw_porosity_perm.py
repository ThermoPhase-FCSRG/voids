# %% [markdown]
# # MWE 20 - DRP-317 Bandera Gray porosity and absolute permeability from RAW image
#
# This notebook estimates porosity and absolute permeability for:
#
# - `examples/data/drp-317/BanderaGray_2d25um_binary.raw`
#
# Provided experimental references:
#
# - Absolute permeability: `Kabs = 9 mD`
# - Porosity: `phi = 18.10%`
...
# %%
# Inputs
raw_relpath = Path("drp-317") / "BanderaGray_2d25um_binary.raw"
voxel_size_um = 2.25
...
analysis_shape_voxels: tuple[int, int, int] | None = (500, 500, 500)
# ROI origin strategy:
# - "center": centered ROI
...
fig = plot_network_plotly(
    ...
    title=(
        f"DRP-317 Bandera Gray network ({flow_axis}-spanning) - pressure field "
...
out_net_full_h5 = out_dir / "BanderaGray_2d25um_network_full_voids.h5"
out_net_span_h5 = out_dir / f"BanderaGray_2d25um_network_{flow_axis}spanning_voids.h5"
out_props_csv = out_dir / "BanderaGray_2d25um_estimated_properties.csv"
out_stats_csv = out_dir / "BanderaGray_2d25um_network_stats.csv"
out_kabs_dir_csv = out_dir / "BanderaGray_2d25um_kabs_directional.csv"
out_roi_scan_csv = out_dir / "BanderaGray_2d25um_roi_scan.csv"
