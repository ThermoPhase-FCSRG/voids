# %% [markdown]
# # MWE 19 - DRP-317 Bentheimer porosity and absolute permeability from RAW image
#
# This notebook estimates porosity and absolute permeability for:
#
# - `examples/data/drp-317/Bentheimer_2d25um_binary.raw`
#
# Provided experimental references:
#
# - Absolute permeability: `Kabs = 386 mD`
# - Porosity: `phi = 22.64%`
...
fig = plot_network_plotly(
    ...
    title=(
        f"DRP-317 Bentheimer network ({flow_axis}-spanning) - pressure field "
...
out_net_full_h5 = out_dir / "Bentheimer_2d25um_network_full_voids.h5"
out_net_span_h5 = out_dir / f"Bentheimer_2d25um_network_{flow_axis}spanning_voids.h5"
out_props_csv = out_dir / "Bentheimer_2d25um_estimated_properties.csv"
out_stats_csv = out_dir / "Bentheimer_2d25um_network_stats.csv"
out_kabs_dir_csv = out_dir / "Bentheimer_2d25um_kabs_directional.csv"
out_roi_scan_csv = out_dir / "Bentheimer_2d25um_roi_scan.csv"
