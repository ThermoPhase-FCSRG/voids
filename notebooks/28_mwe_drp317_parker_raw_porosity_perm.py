# %% [markdown]
# # MWE 28 - DRP-317 Parker porosity and absolute permeability from RAW image
#
# This notebook estimates porosity and absolute permeability for:
#
# - `examples/data/drp-317/Parker_2d25um_binary.raw`
#
# Provided experimental references from Table 1 of the Scientific Reports paper:
#
# - Absolute permeability: `Kabs = 10 mD`
# - Porosity: `phi = 14.77%`
# - Image resolution: `2.25 um`
# - Paper Table 1 sample label: `B`
#
# Workflow highlights:
#
